...
class Articulo {
    ...
    public function alta() {
        ...
        // Sentencia Insert
        $alta = "INSERT INTO articulos (titulo, articulo, autor, fecha, categoria) VALUES (\"".
    ...
    // Funcion borrar que borra el objeto en la base de datos
    ...
    // Funcion modificar que modifica el objeto en la base de datos
    public function modificar() {
        // Establecemos conexion con la BD
        $conexion = blogDB::ConexionBD();
        
        // Sentencia para modificar el objeto
        $modificar = "UPDATE articulos SET titulo=\"$this->titulo\", articulo=\"$this->articulo\", autor=\"$this->autor\", fechaEdicion=STR_TO_DATE(\"$this->fecha\", '%d-%m-%Y %H:%i:%s'), categoria=\"$this->categoria\", editado=true  WHERE id=\"$this->id\"";
        
        // Ejecutamos la sentencia
        $return = $conexion->query($modificar);
    }
